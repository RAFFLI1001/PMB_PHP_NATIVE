    ...
    <div class="row">
        ...
        <div class="col-md-3 col-lg-2 sidebar d-md-block">
            <div class="position-sticky pt-4">
                ...
                <!-- Quick Actions -->
                <h6 class="text-white-50 mb-2 px-3">AKSI CEPAT</h6>
                <div class="px-3 mb-4">
                    <?php if(!$has_registered): ?>
                    <a href="pendaftaran.php" class="btn btn-sm btn-success w-100 mb-2">
                        <i class="fas fa-plus-circle me-1"></i>Daftar PMB
                    </a>
                    <?php elseif($has_registered && $data_pendaftaran['status'] == 'pending'): ?>
                    <a href="test.php" class="btn btn-sm btn-warning w-100 mb-2">
                        <i class="fas fa-play me-1"></i>Mulai Test
                    </a>
                    <?php elseif($has_registered && $data_pendaftaran['status'] == 'lulus' && !$has_daftar_ulang): ?>
                    <a href="daftar_ulang.php" class="btn btn-sm btn-primary w-100 mb-2">
                        <i class="fas fa-check me-1"></i>Daftar Ulang
                    </a>
                    <?php endif; ?>
                </div>
                ...
                <div class="mt-4 px-3 pb-4">
                    <small class="text-white-50 d-block">PMB UTN</small>
                            ...
                            <div class="row align-items-center g-3">
                                <div class="col-md-8">
                                    ...
                                    <p class="card-text text-muted mb-0">
                                        <?php if($has_registered): ?>
                                            Anda telah mendaftar program studi <strong><?php echo htmlspecialchars($data_pendaftaran['nama_jurusan']); ?></strong>.
                                        <?php else: ?>
                        ...
                        <div class="card-body">
                            <div class="steps">
                                <div class="step <?php echo $has_registered ? 'completed' : 'active'; ?>">
                                    <div class="step-icon">
                                        <?php if($has_registered): ?><i class="fas fa-check"></i><?php else: ?><span>1</span><?php endif; ?>
                                    </div>
                                ...
                                <div class="step <?php echo $has_registered ? ($data_pendaftaran['status'] != 'pending' ? 'completed' : 'active') : ''; ?>">
                                    <div class="step-icon">
                                        <?php if($has_registered && $data_pendaftaran['status'] != 'pending'): ?><i class="fas fa-check"></i><?php else: ?><span>2</span><?php endif; ?>
                                    </div>
                                    <div class="step-content">
                                        <h6>Pendaftaran PMB</h6>
                                        <p class="text-muted mb-0">Mengisi formulir pendaftaran</p>
                                        <?php if($has_registered): ?>
                                            <small class="text-success"><?php echo date('d M Y', strtotime($data_pendaftaran['tanggal_daftar'])); ?></small>
                                        <?php endif; ?>
                                    </div>
                                </div>

                                <div class="step <?php echo $has_registered && $data_pendaftaran['status'] != 'pending' ? 'completed' : ''; ?>">
                                    <div class="step-icon">
                                        <?php if($has_registered && $data_pendaftaran['status'] != 'pending'): ?><i class="fas fa-check"></i><?php else: ?><span>3</span><?php endif; ?>
                                    </div>
                                    <div class="step-content">
                                        <h6>Test Online</h6>
                                ...
                                <div class="step <?php echo $has_registered && $data_pendaftaran['status'] == 'lulus' ? 'completed' : ''; ?>">
                                    <div class="step-icon">
                                        <?php if($has_registered && $data_pendaftaran['status'] == 'lulus'): ?><i class="fas fa-check"></i><?php else: ?><span>4</span><?php endif; ?>
                                    </div>
                                    <div class="step-content">
                                        <h6>Hasil Test</h6>
                                ...
                                <div class="step <?php echo $has_daftar_ulang ? 'completed' : ''; ?>">
                                    <div class="step-icon">
                                        <?php if($has_daftar_ulang): ?><i class="fas fa-check"></i><?php else: ?><span>5</span><?php endif; ?>
                                    </div>
                                    <div class="step-content">
                                        <h6>Daftar Ulang</h6>
...
.step.completed .step-icon { background-color: #28a745; color: white; }
...
@media (max-width: 768px) {
    ...
    .step { display: flex; align-items: center; margin-bottom: 20px; text-align: left; width: 100%; }
    .step-icon { margin: 0 15px 0 0; flex-shrink: 0; }
