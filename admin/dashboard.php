            ...
            <div class="row mb-4">
                ...
                <div class="col-xl-3 col-md-6 mb-4">
                    <div class="stat-card stat-card-info">
                        ...
                        <div class="stat-change mt-2">
                            <i class="fas fa-arrow-up me-1"></i>
                            <?php echo $total_pendaftar > 0 ? round(($total_lulus/$total_pendaftar)*100, 1) : 0; ?>% kelulusan
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-md-6 mb-4">
                    <div class="stat-card stat-card-warning">
                        ...
                        <div class="stat-change mt-2">
                            <i class="fas fa-arrow-up me-1"></i>
                            <?php echo $total_lulus > 0 ? round(($total_daftar_ulang/$total_lulus)*100, 1) : 0; ?>% konversi
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="dashboard-card">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $query = "SELECT p.*, cm.nama_lengkap, j.nama_jurusan 
                                              FROM pendaftaran p
                    ...
                    <div class="dashboard-card">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                <div class="me-3">
                                    <div class="rounded-circle" style="width: 12px; height: 12px; background: <?php echo $color; ?>"></div>
                                </div>
